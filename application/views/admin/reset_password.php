...
<html lang="en">
<head>
<?php $this->load->view('admin/widgets/login_meta_tags'); ?>
</head>
<body class="login-container">
<!-- Main navbar -->
<?php $this->load->view('admin/widgets/login_header'); ?>
<!-- /main navbar -->
<!-- Page container -->
<div class="page-container">
  ...
  <div class="page-content">
    ...
    <div class="content-wrapper">
      ...
      <div class="content">
        <!-- Password recovery -->
        <form name="datas_form" id="datas_form" action="<?php echo site_url('admin/login/reset_password/'.$vs_id.'/'.$rand_numbs); ?>" method="post">
        ...
        if(isset($_SESSION['error_msg'])){ ?>
            ...
            <br>
            <div class="text-center"> <a href="<?php echo site_url('admin/login/index'); ?>">Sign-In?</a> </div>
          </div>
        </form>
        ...
        <!-- /password recovery -->
        <!-- Footer -->
        <?php $this->load->view('admin/widgets/login_footer'); ?>
        <!-- /footer -->
      </div>
      <!-- /content area -->
    </div>
