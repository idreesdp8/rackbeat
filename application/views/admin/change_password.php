          ...
          <div class="col-lg-12">
            ...
            <div class="panel panel-flat">
              ...
              <div class="panel-body">
                <form name="datas_form" id="datas_form" method="post" action="<?php echo site_url('admin/settings/change_password'); ?>" class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <span id="old_password1" class="text-danger"> <?php echo form_error('old_password');
                        echo $this->session->flashdata('old_password'); ?></span> </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <span id="new_password1" class="text-danger"><?php echo form_error('new_password'); ?></span> </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <span id="conf_password1" class="text-danger"><?php echo form_error('conf_password'); ?></span> </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <button type="reset" class="btn border-slate text-slate-800 btn-flat" onClick="window.location='<?php echo site_url('admin/settings/change_password'); ?>';"><i class="glyphicon glyphicon-refresh position-left"></i>Clear</button>
                    </div>
                  </div>
                </form>
