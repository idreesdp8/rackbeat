      ...
      <div class="content">
        ...
        if($this->session->flashdata('error_msg')){ ?>
			...
			if(isset($args1) && $args1>0){
				$form_act = "admin/permissions/update/".$args1;
			} ?>
                ...
                if(isset($par_modules_arrs) && count($par_modules_arrs)>0){
                    ...
                    if(isset($chd_modules_arrs) && count($chd_modules_arrs)>0){
                      ...
                      <span id="module_id1" class="text-danger" generated="true"><?php echo form_error('module_id'); ?></span> </div>
                  </div>
                  <div class="form-group">
            ...
            if(isset($role_arrs) && count($role_arrs)>0){
                foreach($role_arrs as $role_arr){ 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-1">
                      <div class="checkbox">
                        <label for="is_add_permission">
                        <input type="checkbox" name="is_add_permission" id="is_add_permission" value="1" <?php if((isset($_POST['is_add_permission']) && $_POST['is_add_permission']==1) || (isset($record) && $record->is_add_permission==1)){ echo 'checked="checked"'; } ?> class="styled">
                        Yes ? </label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <?php }	?>
                      &nbsp;
                      <button type="button" class="btn border-slate text-slate-800 btn-flat" onClick="window.location='<?php echo site_url('admin/permissions/index'); ?>';"><i class="glyphicon glyphicon-chevron-left position-left"></i>Cancel</button>
                    </div>
                  </div>
                </form>
