...
$add_res_nums =  $this->general_model->check_controller_method_permission_access('Admin/Users','add',$this->dbs_role_id,'1'); 
				
$update_res_nums =  $this->general_model->check_controller_method_permission_access('Admin/Users','update',$this->dbs_role_id,'1');   

$trash_res_nums =  $this->general_model->check_controller_method_permission_access('Admin/Users','trash',$this->dbs_role_id,'1');
  ...
  <div class="page-content">
    ...
    <div class="content-wrapper">
      ...
      <div class="content">
        ...
        <?php } ?>
        <input type="hidden" name="add_new_link" id="add_new_link" value="<?php echo site_url('admin/users/add'); ?>">
        ...
        <div class="panel panel-flat">
          ...
          <form name="datas_list_forms" id="datas_list_forms" action="<?php echo site_url('admin/users/trash_multiple'); ?>" method="post">
            <div id="dyns_list">
              <table class="table datatable-button-init-custom">
				...
				if(isset($records) && count($records)>0){
					foreach($records as $record){ 
						$operate_url = 'admin/users/update/'.$record->id;
						$operate_url = site_url($operate_url);
						
						$trash_url = 'admin/users/trash_aj/'.$record->id;
                  ...
                  <tr class="gradeX">
                    <td colspan="9" class="text-center"><strong> No Record Found! </strong></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
