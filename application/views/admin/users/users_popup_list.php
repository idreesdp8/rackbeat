...
function operate_users_list(){ 	 	  
    $(document).ready(function(){ 
        ...
        $.ajax({
            method: "POST",
            url: "<?php echo site_url('/admin/users/users_popup_list2/'); ?>",
...
<?php 
    ...
    <?php } ?>  
     ...
     <div class="loading" style="display: none;"><div class="content"><img src="<?php echo base_url().'admin_assets/images/loading.gif'; ?>"/></div></div> 
  </form>
    </div>  
