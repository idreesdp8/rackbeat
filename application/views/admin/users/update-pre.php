              ...
              <div class="panel-body">
                <?php 
					...
					if(isset($args1) && $args1>0){
						$form_act = "admin/users/update/".$args1;
					} ?>
                <form name="datas_form" id="datas_form" method="post" action="<?php echo site_url($form_act); ?>" class="form-horizontal" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input name="company_name" id="company_name" type="text" class="form-control" value="<?php echo (isset($record)) ? stripslashes($record->company_name): set_value('company_name'); ?>">
                  ...
                  <div class="form-group">
					...
					if(isset($record) && strlen($record->image)>0){ ?>
                      ...
                      <?php echo '( '.$record->image.' )'; } ?> <span id="image1" class="text-danger" generated="true">
                      <?php  
