          ...
          <div class="col-lg-12">
            ...
            <div class="panel panel-flat">
              ...
              <div class="panel-body">
                <form name="datas_form" id="datas_form" method="post" action="<?php echo site_url('admin/settings/config'); ?>" class="form-horizontal" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input name="phone_no" id="phone_no" type="text" class="form-control" value="<?php echo (isset($_POST['phone_no'])) ? set_value('phone_no') : $vs_phone_no; ?>" data-error="#phone_no1">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input name="website" id="website" type="text" class="form-control" value="<?php echo (isset($_POST['website'])) ? set_value('website') : $vs_website; ?>" data-error="#website1">
                      <span id="website1" class="text-danger"><?php echo form_error('website'); ?></span> </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="hidden" name="old_image" id="old_image" value="<?php echo $vs_image; ?>">
                      <?php echo '( '.$vs_image.'	)'; } ?> <span id="image1" class="text-danger">
                      <?php 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <span id="disclaimer1" class="text-danger"><?php echo form_error('disclaimer'); ?></span> </div>
                  </div>
                  <div class="form-group">
                    <label class="col-md-2 control-label" for="address_1">Address <span class="reds"> *</span></label>
                    <div class="col-md-6">
                      <textarea name="address_1" id="address_1" class="form-control" rows="4" data-error="#address_11"><?php echo (isset($_POST['address_1'])) ? set_value('address_1') : $vs_address_1; ?></textarea>
                      <span id="address_11" class="text-danger"><?php echo form_error('address_1'); ?></span> </div>
                  </div>
                  <div class="form-group">
                    <label class="col-md-2 control-label" for="copyrights">Copyrights <span class="reds"> *</span></label>
                    <div class="col-md-6">
                      <textarea name="copyrights" id="copyrights" class="form-control" rows="3" data-error="#copyrights1"><?php echo (isset($_POST['copyrights'])) ? set_value('copyrights') : $vs_copyrights; ?></textarea>
                      <span id="copyrights1" class="text-danger"><?php echo form_error('copyrights'); ?></span> </div>
                  </div>
                  <div class="form-group">
