                  ...
                  <div class="row">
                    <div class="col-md-9">
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input name="page_name" id="page_name" type="text" class="form-control" value="<?php echo set_value('page_name'); ?>" data-error="#page_name1">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input name="page_slug" id="page_slug" type="text" class="form-control" value="<?php echo set_value('page_slug'); ?>" data-error="#page_slug1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input name="meta_title" id="meta_title" type="text" class="form-control" value="<?php echo set_value('meta_title'); ?>" data-error="#meta_title1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8"> 
						  <textarea name="meta_keyword" id="meta_keyword" type="text" class="form-control" data-error="#meta_keyword1" rows="5"><?php echo set_value('meta_keyword'); ?></textarea> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
							<textarea name="meta_description" id="meta_description" type="text" class="form-control" data-error="#meta_description1" rows="5"><?php echo set_value('meta_description'); ?></textarea> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <textarea name="summary" id="summary" type="text" class="form-control" data-error="#summary1" rows="5"><?php echo set_value('summary'); ?></textarea>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <textarea name="details" id="details" type="text" class="form-control" data-error="#details1" rows="5"><?php echo set_value('details'); ?></textarea>
