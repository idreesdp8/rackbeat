              ...
              <div class="panel-body">
                <form name="datas_form" id="datas_form" method="post" action="<?php echo site_url('admin/settings/my_profile'); ?>" class="form-horizontal" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input name="mobile_no" id="mobile_no" type="text" class="form-control" value="<?php echo (isset($_POST['mobile_no'])) ? set_value('mobile_no') : $vs_mobile_no; ?>" data-error="#mobile_no1">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input name="company_name" id="company_name" type="text" class="form-control" value="<?php echo (isset($_POST['company_name'])) ? set_value('company_name') : $vs_company_name; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <?php echo '( '.$vs_image.'	)'; } ?> <span id="image1" class="text-danger" generated="true">
                      <?php 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <textarea name="address" id="address" class="form-control" rows="5" data-error="#address1"><?php echo (isset($_POST['address'])) ? set_value('address') : $vs_address; ?></textarea>
