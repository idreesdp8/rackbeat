...
<body>
    <div class="print-page" style="padding: 1.25rem;">
        <p style="font-size: 16px; font-family: <?php echo $design->font_style ?>"><?php echo $product->number ?></p>
        ...
        <div style="display: flex; justify-content: space-between;">
            ...
            <p style="font-size: 14px; font-family: <?php echo $design->font_style ?>">Lot #: <?php echo date('d/m/Y', strtotime($product->created_at)) ?></p>
        </div>
        <img id="preview_img" src="<?php echo barcode_url() . $barcode_image ?>" alt="" style="width: 100%;">
        <p style="font-family: <?php echo $design->font_style ?>">Group: <?php echo $product->group ? $product->group->name : 'NA' ?></p>
    </div>
