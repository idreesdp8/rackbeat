...
class Accounts extends CI_Controller{
	...
	function users_list(){
		...
		if($res_nums>0){ 
			$data['page_headings']="Users List";
			$data['records'] = $this->admin_model->get_all_users_with_roles(); 
			$this->load->view('admin/accounts/users_list',$data);   
	...
	function trash_user($args2=''){    
		...
		if($res_nums>0){ 
			...
			redirect('admin/accounts/users_list');    
	 ...
	 function trash_user_aj(){   
		...
		if($res_nums>0){  
			...
			if(isset($_POST["args1"]) && $_POST["args1"]>0){
			 ...
			 $data['records'] = $this->admin_model->get_all_users_with_roles();
			 $this->load->view('admin/accounts/users_list_aj',$data);   
	...
	function operate_user($args1=''){ 
		...
		if(isset($_POST) && !empty($_POST)){ 
			...
			// validation fail
				$this->load->view('admin/accounts/operate_user',$data);
				...
				if(isset($_POST['saves_and_new'])){
					redirect("admin/accounts/operate_user");
				}else{
					redirect("admin/accounts/users_list");	
				} 
			} 	 
	...
	function roles_list(){ 
		...
		if($res_nums>0){ 
			...
			$this->load->view('admin/accounts/roles_list',$data);  
	...
	function trash_role($args2=''){  
		...
		if($res_nums>0){
			...
			redirect('admin/accounts/roles_list'); 
	 ...
	 function trash_role_aj(){  
		...
		if($res_nums>0){
			 ...
			 $data['records'] = $this->admin_model->get_all_roles();
			 $this->load->view('admin/accounts/roles_list_aj',$data); 
	 ...
	 function operate_role($args1=''){  
		...
		if(isset($_POST) && !empty($_POST)){
			...
			if($this->form_validation->run() == FALSE){
			// validation fail
				$this->load->view('admin/accounts/operate_role',$data);
			}else if(isset($args1) && $args1!=''){ 
				...
				if(isset($_POST['saves_and_new'])){
					redirect("admin/accounts/operate_role");
				}else{
					redirect("admin/accounts/roles_list");	
				}
			} 	 
	...
	function modules_list(){ 
		...
		if($res_nums>0){  
			...
			$this->load->view('admin/accounts/modules_list',$data);
	...
	function trash_module($args2=''){ 
		...
		if($res_nums>0){
			...
			redirect('admin/accounts/modules_list'); 
	 ...
	 function trash_module_aj(){ 
		...
		if($res_nums>0){
			...
			$data['records'] = $this->admin_model->get_all_modules();
			$this->load->view('admin/accounts/modules_list_aj',$data);
	 ...
	 function operate_module($args1=''){  
		...
		if(isset($_POST) && !empty($_POST)){
			...
			if($this->form_validation->run() == FALSE){
				// validation fail
				$this->load->view('admin/accounts/operate_module',$data);
			}else if(isset($args1) && $args1!=''){
				...
				if(isset($_POST['saves_and_new'])){
					redirect("admin/accounts/operate_module");
				}else{
					redirect("admin/accounts/modules_list");	
				}
			} 	 
	...
	function permissions_list(){
		...
		$this->load->view('admin/accounts/permissions_list',$data); 
	...
	if(isset($_POST['user_type_id'])){
	   ...
	   $data['records'] = $this->admin_model->get_all_permission_with_user_modules_roles($paras_arrs);
		...
		$data['page_headings']="Permissions List";
		$this->load->view('admin/accounts/permissions_list2',$data); 
	...
	function trash_permission($args2=''){  
		...
		if($res_nums>0){
			...
			redirect('admin/admin/permissions_list');  
	...
	function operate_permission($args1=''){ 
		...
		if(isset($_POST) && !empty($_POST)){
			...
			if($this->form_validation->run() == FALSE){
				// validation fail
				$this->load->view('admin/accounts/operate_permission',$data);
				...
				if(isset($res)){
					...
					redirect("admin/accounts/permissions_list");
				...
				if(isset($_POST['saves_and_new'])){
					redirect("admin/accounts/operate_permission");
				}else{
					redirect("admin/accounts/permissions_list");	
				}
